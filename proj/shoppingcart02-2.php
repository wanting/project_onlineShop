    ...
    <form action="shopping-api.php" method="post" id="h_formlist" class="" name="order1" onsubmit="return formCheck()">
      <table class="table h_table-m">
        ...
        <tbody>
          <tr>
            <td>
              <input type="radio" id="h_atm" name="payment" value="ATM代碼繳費" checked>
              <label class="h_cartTitle font5" for="h_atm">　ATM代碼繳費</label>
              <hr>
              <img src="../img/atm.png" alt="">
              <div class="h_atmScript font6">
                請至超商機台輸入代碼，產生繳費單後前往櫃檯繳費<br>
                注意事項：本訂單超商代碼的繳費期限為7天，請務必於期限內進行繳款。
              </div>
              <hr>
      ...
      <table class="table h_table-m">
        ...
        <tbody>
          <tr>
            <td>
              <div class="form-group">
                <textarea class="form-control font5" id="exampleFormControlTextarea1" rows="3" placeholder="若有購買上的特別需求，請填寫備註"></textarea>
              </div>
            </td>
          </tr>
        </tbody>
