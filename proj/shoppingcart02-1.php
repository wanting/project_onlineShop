...
// 呼叫mobile
// origin
// $m_sql = "SELECT * FROM members WHERE `sid`=" . intval($_SESSION['member']['sid']);
...
<div class="row h_row h_mixRow">
  <div class="col-7 h_row7 h_tableRwd">
    <form method="post" id="h_formlist" class="" name="order1" onsubmit="return formCheck()">
      <table class="table h_table-m">
        ...
        <tbody>
          <tr>
            <td>
              <input type="radio" id="convenienceStore" name="payment" value="超商取貨付款" checked>
              <label class="h_cartTitle font5" for="convenienceStore">　超商取貨付款</label>
              <hr>
              <div class="form-group row sevenmart">
                <div class="sevenimg">
                  <img src="../img/7-11logo.svg.png" alt="">
                </div>
                <div class="col-sm-6 sevenmart">
                  <select class="form-control card font5">
                    <option>請選擇取貨門市</option>
                    <option>上弘門市</option>
                    <option>小巨蛋門市</option>
                    <option>中崙門市</option>
                    <option>北體門市</option>
      ...
      <table class="table h_table-m">
        ...
        <tbody>
          ...
          <!-- 運作方式? r跟i的差異? 如何都改成r叫值進入 -->
          <?php //$i = $_SESSION['member']; 
          ?>
            ...
            <td>
              ...
              <div class="form-group">
                <div class="form-check">
                  <!-- <input class="form-check-input is-invalid h_chb" type="checkbox" value="" id="invalidCheck3" required> -->
                  <input class="form-check-input is-invalid" type="checkbox" value="" id="invalidCheck1" required>
                  <label class="form-check-label font5 col-sm-8" for="invalidCheck1">
                    我已經閱讀並同意隱私權保護政策條款
                  </label>
                  <small id="h_chbWarning" class="col-sm-4 font6">
                  </small>
                </div>
              </div>
            </td>
          ...
          <tr>
            <td>
              ...
              <div class="form-group row">
                ...
                <small id="h_nameWarning" class="col-sm-4 font6">
                </small>
              </div>
              <div class="h-line"></div>
              <div class="form-group row">
                ...
                <small id="h_phoneWarning" class="col-sm-4 font6">
                </small>
              </div>
              <div class="h-line"></div>
              ...
              <div class="form-group row">
                ...
                <small id="h_mailWarning" class="col-sm-4 font6">
                </small>
              </div>
              <div class="h-line"></div>
            </td>
        ...
        <tr>
          <td class="button" colspan="3">
            <div class="h_textCenter h_icon green_btn">
              <a class="" role="button" href="shoppingcart01.php">回上一頁</a>
            </div>
          </td>
        </tr>
        <tr>
          <td class="button" colspan="3">
            <div class="h_textCenter h_icon red_btn">
              <a id="h_send" class="" role="button">提交訂單</a>
            </div>
          </td>
        </tr>
      </tbody>
...
<script>
  ...
  // 同訂購人的核取方塊
  // $("#sameBuyer").click(function() {
  //   const checked = $(this).prop('checked');
  //   if(checked) {
  //       $('#h_inputNameRecipient').val($('#h_inputNameBuyer').val());
  //       $('#h_inputPhoneRecipient').val($('#h_inputPhoneBuyer').val());
  //       $('#h_inputEmailRecipient').val($('#h_inputEmailBuyer').val());
  //   }
  // }
