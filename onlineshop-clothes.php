...
*/
// --- 分類資料
$c_sql = "SELECT * FROM `categories` WHERE `parent_sid`=4";
    ...
    <ul class="b-menu-n">
        <li id="b-drop-down">
            <ul class="d-flex justify-content-center  b-list-n bb-button" href="">
                ...
                <a class="b-all-n label-text">Clothes </a> <i class="b-down-arrow-n "></i>
            </ul>
...
<nav aria-label="breadcrumb" class="y-bread-list breadcrumb-2">
        <ol class="breadcrumb">
            ...
            <li class="font5 breadcrumb-item active" aria-current="page">Clothes</li>
        </ol>
    </nav>
<!-- <script>
